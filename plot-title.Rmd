...
Let's adding title, subtitle of the plot in ggplot2 using of ggtitle
...
ggplot(data, aes(x = Sepal.Width, y = Petal.Width, fill = Species)) +
  geom_bar(stat = "identity") + 
  facet_wrap(~Species) +
  ggtitle("Title of the plot",
          subtitle = "Subtitle of the plot")->p
p
```
...
ggplot(data, aes(x = Sepal.Width, y = Petal.Width)) +
  geom_area(fill = rgb(0, 0.5, 1, alpha = 0.5)) +
  labs(subtitle = "Subtitle on the plot")
