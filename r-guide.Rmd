...
R is one of the most popular programming languages in statistical computing. It’s an open-source, easy to learn, and easy to use to manipulating statistical data. This R guide will cover a basic  overview of getting started with R. 
